...
public class MainActivity extends AppCompatActivity {
    ...
    private void alertdialoggoster(String secilieleman) {
    ...
    public void VeriOkuma(){
        ...
        String[] Sutun={"ID","KullaniciAdi","Sifre","Email"};
        int[] idler ={R.id.tvID,R.id.tvKullanici,R.id.tvSifre,R.id.tvEmail};
